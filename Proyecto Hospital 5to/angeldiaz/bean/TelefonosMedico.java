...
public class TelefonosMedico {
    ...
    public TelefonosMedico() {
    }

    public TelefonosMedico(int codigoTelefonoMedico, String telefonoPersonal, String telefonoTrabajo, int codigoMedico) {
